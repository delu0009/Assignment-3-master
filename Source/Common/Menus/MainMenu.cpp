...
{
    addButton(new UIButton("ButtonLoadLevel"));//creation of buttons on the main menu
...
void MainMenu::buttonAction(UIButton* button)
{
    ...
    if(index == 0)//load a screen based the button that the function takes as a parameter
    {
